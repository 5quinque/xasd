...
watchEffect(() => {
    // console.log("in editableplaylisttitle watchEffect playlist_name_input: " + playlist_name_input.value, props.playlist.name)
    playlist_name_input.value = props.playlist.name
})
...
<template>
    <div class="editable-text">
        <div class="row">
            <div class="col-5 form-outline d-flex">
                <PlaylistOptions v-if="playlist" :playlist="playlist" />
